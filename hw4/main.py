...
def change_set_by_factors(XY_test, factors):
    XY_test_transformed = XY_test.copy()
    for f, (w, op) in factors.items():
        XY_test_transformed.loc[:, f] = op(XY_test_transformed.loc[:, f], w)
    return XY_test_transformed
